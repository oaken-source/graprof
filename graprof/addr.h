 ...
 */
int addr_extract_symbols(const char *filename, uintptr_t offset) __may_fail;
 ...
 *   -1 on failure, 0 on success
 */
int addr_translate(uintptr_t pc, char **function, char **file, unsigned int *line) __may_fail;
