 ...
 */
int memory_malloc(size_t size, uintptr_t caller, uintptr_t result, unsigned long long time) __may_fail;
 ...
 *   -1 on failure, 0 on success
 */
int memory_realloc(uintptr_t ptr, size_t size, uintptr_t caller, uintptr_t result, unsigned long long time) __may_fail;
 ...
 *   -1 on failure, 0 on success
 */
int memory_free(uintptr_t ptr, uintptr_t caller, unsigned long long time) __may_fail;
